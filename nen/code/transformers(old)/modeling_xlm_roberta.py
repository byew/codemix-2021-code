...
from .modeling_roberta import (
    ...
    RobertaForSequenceClassification_cnn,
    RobertaForSequenceClassification_new,
...
class XLMRobertaForSequenceClassification(RobertaForSequenceClassification_cnn):
    """
