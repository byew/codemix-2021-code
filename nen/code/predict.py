...
from transformers import RobertaForSequenceClassification, RobertaTokenizer, XLMRobertaForSequenceClassification, XLMRobertaTokenizer
...
MODEL_CLASSES = {
    ...
    'xlmroberta':(xlmroberta_model, XLMRobertaTokenizer),
    'deberta': (deberta, DebertaTokenizer),
}
...
#     # 5 is 5 label
#     preds_logits = preds_logits.reshape(output_len, 5)
#     # print(preds_logits)
#     # print(predictions)
#     return predictions, preds_logits
